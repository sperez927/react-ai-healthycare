...
[![CI](https://img.shields.io/github/actions/workflow/status/sperez927/react-ai-healthycare/ci.yml?branch=main&label=CI)](https://github.com/sperez927/react-ai-healthycare/actions)
...
```bash
git clone https://github.com/sperez927/react-ai-healthycare.git
cd resilience
docker compose up
```

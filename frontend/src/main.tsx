import { createRootErrorHandlers } from './instrument'
...
const rootOptions = createRootErrorHandlers()
const root = rootOptions ? createRoot(rootElement, rootOptions) : createRoot(rootElement)

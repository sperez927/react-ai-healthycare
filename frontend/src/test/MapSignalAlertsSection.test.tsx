...
describe('MapSignalAlertsSection', () => {
  ...
  it('renders no stale-basis tag when the signal is fresh', () => {
    ...
    renderSection()
    expect(screen.queryByTestId('map-signal-alert-stale-basis')).toBeNull()
  })
  ...
  it('renders an aging stale-basis tag when the signal is older than agingMs', () => {
    ...
    renderSection()
    expect(screen.getByTestId('map-signal-alert-stale-basis')).toHaveTextContent('aging')
  })
  ...
  it('renders a stale stale-basis tag when the signal is older than staleMs', () => {
    ...
    renderSection()
    expect(screen.getByTestId('map-signal-alert-stale-basis')).toHaveTextContent('stale')
  })
})
